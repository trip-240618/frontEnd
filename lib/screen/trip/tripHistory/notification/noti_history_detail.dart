    ...
    return GestureDetector(
      ...
      child: Scaffold(
        body: Obx(()=>SingleChildScrollView(
          ...
          child: notis.notificationHistory.length==0?const SizedBox():Padding(
                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                Text('${notis.notificationHistory['nickname']}',style: f12whitew600,),
                                const SizedBox(width: 4,),
                                Text('${notis.notificationHistory['photoDate']}',style: f12whitew600,)
                              ],
                            ),
                            const SizedBox(height: 4,),
                            const SizedBox(),
                            notis.notificationHistory['memo']==''?const SizedBox():Wrap(
                              children: [
                                Text(
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  const SizedBox(width: 8,),
                                  Text('${notis.notificationComment[index]['nickname']}',style: f12Gray800w600),
                                  const SizedBox(width: 6,),
                                  Text('${hs.timeFormat(notis.notificationComment[index]['createDate'])}',style: f11gray400w500,),
                                  Spacer(),
                                  us.userList[0].uuid==notis.notificationComment[index]['writerUuid']
                                      ...
                                      itemBuilder: (context) => [
                                        PopupMenuItem(
                                          onTap: () async {
                                            await rs.addReport('reply',notis.notificationComment[index]['id'], notis.notificationComment[index]['id']);
                                          },
                                          padding: EdgeInsets.zero,
                                          value: 1,
                                          child: Column(
                              ...
                              // const SizedBox(height: 4),
                              Text('${notis.notificationComment[index]['content']}',style: f14gray800w600),
