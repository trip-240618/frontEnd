...
import 'package:tripStory/screen/trip/tripPlan/typeJ/jplan_swap_page.dart';
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                            ...
                            child: Text('순서 변경',style: f12gray600w600,))
                      ],
                    ),
                                    ...
                                    children: [
                                      Expanded(
                                        child: GestureDetector(
                                          behavior: HitTestBehavior.opaque,
                                          onTap:()async{
                                            if(js.jPlanList[0]['planList'][index]['latitude']!=null&&js.jPlanList[0]['planList'][index]['longitude']!=null){
                                              CameraPosition cameraPosition = CameraPosition(
                                                  target: LatLng(js.jPlanList[0]['planList'][index]['latitude'], js.jPlanList[0]['planList'][index]['longitude']),
                                                  zoom: 12);
                                              final GoogleMapController controller = await js.mapController.future;
