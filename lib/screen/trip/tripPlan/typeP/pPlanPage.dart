...
class _PPlanPageState extends State<PPlanPage> {
  ...
  bool isLoading = true;
  bool isAdding = false; /// 새로운 플랜을 추가 중인지 나타내는 상태
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: Padding(
                                        padding: const EdgeInsets.symmetric(vertical: 2,horizontal: 12),
                                        child: Text('Day ${ps.pPlanList[0]['dayList'][selectDayIdx]['dayAfterStart']}', style: f12mainw700(Color(ts.selectTripList[0]['labelColor']),),),
                                      ),
                                    ),
                                    const SizedBox(width: 6,),
                                    ...
                                    Spacer(),
                                    ps.pPlanList[0]['dayList'][selectDayIdx]['planList'].where((plan) => plan['checkbox'] == true).length == 0
                                      ...
                                      : Container(
                                          ...
                                          decoration: BoxDecoration(
                                            ...
                                            borderRadius: BorderRadius.circular(100),),
                                          child: Center(
                                            child: Text('${ps.pPlanList[0]['dayList'][selectDayIdx]['planList'].where((plan) => plan['checkbox'] == true).length}', style: f12Whitew700,),
                                          ),
                                    ),
                                    ps.pPlanList[0]['dayList'][selectDayIdx]['planList'].where((plan) => plan['checkbox'] == false).length == 0
                                      ? const SizedBox()
                                      : Padding(padding: const EdgeInsets.only(left: 4),
                                          child: Container(
                                            ...
                                            child: Center(
                                              child: Text('${ps.pPlanList[0]['dayList'][selectDayIdx]['planList'].where((plan) => plan['checkbox'] == false).length}', style: f12Whitew700,),
                                            ),
                                          ),
                                      ),
                                    InkWell(
                            ...
                            Column(
                              ...
                              children: [
                                AnimatedSize(
                                  ...
                                  child: ps.pPlanList[0]['dayList'][selectDayIdx]['isExpanded'] == true
                                      ? Padding(
                                    padding: ps.pPlanList[0]['dayList'][selectDayIdx]['planList'].length==0?EdgeInsets.zero:EdgeInsets.only(top: 16),
                                    child: Container(
                                      color: gray50,
                                      child: ListView.builder(
                                        shrinkWrap: true,
                                        itemCount: ps.pPlanList[0]['dayList'][selectDayIdx]['planList'].length==0?1:ps.pPlanList[0]['dayList'][selectDayIdx]['planList'].length,
                                        physics: const ClampingScrollPhysics(),
                                        itemBuilder: (context, planIndex) {
                                          return ps.pPlanList[0]['dayList'][selectDayIdx]['planList'].length==0?const SizedBox(height: 16,):Padding(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                const SizedBox(height: 16,),
                                                ps.pPlanList[0]['dayList'][selectDayIdx]['planList'][planIndex]['checkbox']?
                                                Container(
                                                  width: 20,
                                                  height: 20,
                                                  decoration: BoxDecoration(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      InkWell(
                                        ...
                                        child: Container(
                                          padding: EdgeInsets.all(10),
                                          child: _focusNode.hasFocus?SvgPicture.asset('assets/icon/disabledRoundPlus.svg'):SvgPicture.asset('assets/icon/enabledRoundPlus.svg'),
                                        ),
                                      ),
                                    ],
                                  ),
                                          ...
                                          return ps.pPlanList[0]['dayList'][dayIndex]['planList'].length==0?const SizedBox(height: 16,):Padding(
                                            ...
                                            child: GestureDetector(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  const SizedBox(height: 16,),
                                                  ps.pPlanList[0]['dayList'][dayIndex]['planList'][planIndex]['checkbox']?
                                                    Container(
                                                      width: 20,
                                                      height: 20,
                                                      decoration: BoxDecoration(
