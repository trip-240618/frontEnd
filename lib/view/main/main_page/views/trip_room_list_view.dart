                  ...
                  Obx(() => GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Stack(children: [
                          ...
                          notis.notificationCount.value == 0
                              ? const SizedBox()
                              : Positioned(
                                  right: 0,
                                  child: Container(
              ...
              Obx(() => Row(
                    children: [
                      GestureDetector(
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                              color: ms.selectIdx == 0 ? gray900 : gray200, borderRadius: BorderRadius.circular(100)),
                          child: Padding(
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                              color: ms.selectIdx == 1 ? gray900 : gray200, borderRadius: BorderRadius.circular(100)),
                          child: Padding(
                            padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 4),
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                              color: ms.selectIdx == 2 ? gray900 : gray200, borderRadius: BorderRadius.circular(100)),
                          child: Padding(
                            padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 4),
                                                          ...
                                                          children: [
                                                            ms.selectIdx.value == 1
                                                                ? SvgPicture.asset('assets/icon/calender.svg',
                                                                    colorFilter:
                                                                        ColorFilter.mode(gray600, BlendMode.srcIn))
                                                                : Container(
                                                                    decoration: BoxDecoration(
                                                                        border: Border.all(
                                                                          color: Color(int.parse(
                                                                              '${ms.tripList[index]['labelColor']}')),
                                                                          width: 1.5, // 1.5px 두께
                                                                        ),
                                                                    ...
                                                                    child: Padding(
                                                                      ...
                                                                      child: Text(
                                                                        (DateTime.parse('${ms.tripList[index]['startDate']}')
                                                                                        .difference(DateTime.now())
                                                                                        .inDays +
                                                                                    1) <
                                                                                1
                                                                            ? '여행중'
                                                                            : 'D-${DateTime.parse('${ms.tripList[index]['startDate']}').difference(DateTime.now()).inDays + 1}',
                                                            ...
                                                            Text(
                                                              '${ms.tripList[index]['startDate']} ~ ${ms.tripList[index]['endDate']}',
                                                            ...
                                                            InkWell(
                                                              onTap: () async {
                                                                await ms.bookmarkClick(
                                                                    int.parse('${ms.tripList[index]['id']}'));
                                                                ms.tripList[index]['bookmark'] =
                                                                    !ms.tripList[index]['bookmark'];
                                                                ms.tripList.refresh();
                                                              },
                                                          ...
                                                          children: [
                                                            Container(
                                                              ...
                                                              child: ClipRRect(
                                                                ...
                                                                child: ms.tripList[index]['thumbnail'] == ''
                                                                ...
                                                                Row(
                                                                  children: [
                                                                    Container(
                                                                        ...
                                                                        child: Center(
                                                                            child: Text(
                                                                          '${ms.tripList[index]['type']}',
                                                                          style: f12Whitew700,
                                                                        ))),
                                                                    const SizedBox(width: 6),
                                                                    Text(
                                                                      '${ms.tripList[index]['name']}',
                                                                      ...
                                                                      child: Padding(
                                                                        ...
                                                                        child: Row(
                                                                          children: [
                                                                            ...
                                                                            Text(
                                                                              '${ms.tripList[index]['tripMemberDtoList'].length}',
