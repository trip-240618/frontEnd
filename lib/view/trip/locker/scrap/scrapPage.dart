...
import 'package:tripStory/view/trip/locker/scrap/scrap_edit.dart';
import 'package:tripStory/view/trip/locker/scrap/scrap_view.dart';
                          ...
                          () => Expanded(
                            ...
                            itemBuilder: (context, index) {
                              return GestureDetector(
                                onTap: () async {
                                  await ss.getSelectScrapList(
                                      ss.scrapList[index]['id']);
                                  us.userList[0].uuid ==
                                          ss.scrapList[index]['writerUuid']
                                      ? Get.to(() => ScrapEdit())
                                      : Get.to(() => ScrapView());
                                },
                                child: Container(
                                  decoration: BoxDecoration(
                                      ...
                                      color: Colors.white,
                                      border:
                                          Border.all(color: gray200, width: 1)),
                                  //height: 194*(index/2),
                                  constraints: BoxConstraints(
                                      maxHeight: 231, minHeight: 133),
                                  child: Column(
                                          ...
                                          child: Row(
                                            children: [
                                              GestureDetector(
                                                ...
                                                onTap: () async {
                                                  await ss.clickScrapBookmark(ss
                                                      .scrapList[index]['id']);
                                                  ss.scrapList[index]
                                                          ['bookmark'] =
                                                      !ss.scrapList[index]
                                      ...
                                      Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                                jsonToString(ss.scrapList[index]
                                                    ['preview']),
                                                overflow: TextOverflow.ellipsis,
                                                maxLines: 4,
