                              ...
                              children: [
                                Expanded(
                                  child: GestureDetector(
                                    ...
                                    onTap: () {
                                      /// 이미 선택된 날짜 한번더 클릭
                                      if (js.editPlanJList[0]['planList'][index]['planId'] ==
                                          js.firstSwapList['planId']) {
                                        js.firstSwapList.value = {};
                                        js.editPlanJList.refresh();
                                      }

                                      /// 선택된 리스트 스왑
                                      else if (js.firstSwapList.isNotEmpty &&
                                          js.editPlanJList[0]['planList'][index]['planId'] !=
                                              js.firstSwapList['planId']) {
                                        int swapIndex = js.editPlanJList[0]['planList']
                                            .indexWhere((item) => item['planId'] == js.firstSwapList['planId']);

                                        var temp = js.editPlanJList[0]['planList'][index];
                                        js.editPlanJList[0]['planList'][index] =
                                            js.editPlanJList[0]['planList'][swapIndex];
                                        js.editPlanJList[0]['planList'][swapIndex] = temp;

                                        var tempStartTime = js.editPlanJList[0]['planList'][index]['startTime'];
                                        js.editPlanJList[0]['planList'][index]['startTime'] =
                                            js.editPlanJList[0]['planList'][swapIndex]['startTime'];
                                        ...
                                        js.editPlanJList[0]['planList'][index]['orderByDate'] =
                                            js.editPlanJList[0]['planList'][swapIndex]['orderByDate'];
                                    ...
                                    child: Container(
                                      decoration: BoxDecoration(
                                          border: js.editPlanJList[0]['planList'][index]['planId'] ==
                                                  js.firstSwapList['planId']
                                              ? Border.all(color: gray900)
                                              : null,
                                      ...
                                      child: Row(
                                        children: [
                                          Container(
                                              ...
                                              child: Center(
                                                  child: Text(
                                                '${js.editPlanJList[0]['planList'][index]['startTime'].toString().substring(0, 5)}',
                                                  ...
                                                  children: [
                                                    js.editPlanJList[0]['planList'][index]['memo'] != ''
                                                        ? PopupMenuButton(
                                                            offset: Offset(-34, 35),
                                                            shape: TooltipShape(
                                                                borderColor: Color(ts.selectTripList[0]['labelColor']),
                                                                borderWidth: 1),
                                                    ...
                                                    Expanded(
                                                        child: Text(
                                                      '${js.editPlanJList[0]['planList'][index]['title']}',
                                                      style: f12Gray800w500,
