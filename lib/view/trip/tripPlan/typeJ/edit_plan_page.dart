  ...
  void initState() {
    ...
    if(js.selectJplan['place']!=null&&js.selectJplan['place']!=''){
      Map data = {
        "formattedAddress": "",
        "location": {
          "latitude": js.selectJplan['latitude'],
          "longitude": js.selectJplan['longitude']
        },
        "displayName": {
          "text": js.selectJplan['place'],
          "languageCode": "ko"
        }
      };
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: BackAppBar(text: '일정 수정',color: Colors.white,
            onTap: (){
              js.searchLocation.clear();
              Get.back();
            }),
                        ...
                        GestureDetector(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text('${js.editDate}', style: f15gray800w500,),
                            ],
                          ),
                        ),
