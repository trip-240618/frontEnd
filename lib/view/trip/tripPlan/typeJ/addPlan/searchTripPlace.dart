                              ...
                              itemBuilder: (context, index) {
                                return Container(
                                  decoration: BoxDecoration(
                                    ...
                                    bottom:
                                        index == placeList.length - 1 ? BorderSide(color: gray200) : BorderSide.none,
                                  )),
                                  child: Padding(
                                          ...
                                          child: Container(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                Container(
                                                    decoration: BoxDecoration(
                                                        color: gray200, borderRadius: BorderRadius.circular(30)),
                                                    child: Padding(
                                                ...
                                                Expanded(
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      Text(
                                                        "${getPlaceName(placeList[index]['address'], placeList[index]['secondaryAddress']) ?? ""}",
                                                        style: f12gray600W700,
                                                      ),
                                                      const SizedBox(
                                                        height: 4,
                                                      ),
