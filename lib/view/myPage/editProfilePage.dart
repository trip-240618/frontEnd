          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                              ...
                              children: [
                                ...
                                Positioned(
                                  ...
                                  child: Container(
                                    ...
                                    child: SvgPicture.asset('assets/icon/photo.svg',
                                        fit: BoxFit.none, colorFilter: ColorFilter.mode(gray500, BlendMode.srcIn)),
                                  ),
                                )
                              ],
                            ),
                ...
                Text(
                  '닉네임',
                  style: f12gray700W700,
                ),
                const SizedBox(height: 10),
                Container(
                  width: Get.width,
                  decoration: BoxDecoration(
                      color: gray50, borderRadius: BorderRadius.circular(4), border: Border.all(color: gray200)),
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                              '${_memoCon.text.length}',
                              style: _memoCon.text.length > 0 ? f11Gray800w600 : f11Gray400w600,
                            ),
                            Text(
                              '/16 ',
                              style: f11Gray400w600,
              ...
              onTap: () async {
                showConfirmCancelTapDialog(context, '프로필을 수정하시겠습니까?', '확인', null, () async {
                  if (pickedImage != null) {
                    ...
                    await us.userModify(
                        _nickCon.text, _memoCon.text, '${us.userList[0].thumbnail}', '${us.userList[0].profileImg}');
                  }
                  Get.back();
                  Get.back();
                });
