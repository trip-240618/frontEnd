          ...
          children: [
            Container(
              decoration: BoxDecoration(
                  color: Colors.white, borderRadius: BorderRadius.circular(4), border: Border.all(color: gray200)),
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return Container(
                    decoration: BoxDecoration(
                      border: Border(
                        bottom: memberList.length - 1 == index
                            ? BorderSide.none
                            : BorderSide(
                                // 아래쪽(border bottom)만 색상 적용
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                              ...
                              ? Container(
                                  ...
                                  child: Stack(
                                    children: [
                                      ...
                                      Positioned(bottom: 0, right: 0, child: SvgPicture.asset('assets/icon/owner.svg'))
                                    ],
                                  ),
                                )
                              : Container(
                          ...
                          Spacer(),
                          !leaderCheck && us.userList[0].uuid != memberList[index]['uuid']
                              ? const SizedBox()
                              : us.userList[0].uuid == memberList[index]['uuid']
                                  ? GestureDetector(
