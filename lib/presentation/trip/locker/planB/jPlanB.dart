...
// import 'package:tripStory/core/util/tooltip_shape.dart';
// import 'package:tripStory/presentation/trip/locker/planB/add_planB_j.dart';
// import 'package:tripStory/presentation/trip/locker/planB/edit_planB_j.dart';
//
...
//                                                 child: Text(
//                                                   'Day ${js.planBJList[dayIndex]['dayAfterStart']}',
//                                                   style: f12mainw700(
...
//                                       js.planBJList[dayIndex]['dayAfterStart'] != -1
//                                           ? Text(
//                                               '${DateFormat('M.d (E)', 'ko').format(DateTime.parse(ts.selectTripList[0]['startDate']).add(Duration(days: js.planBJList[dayIndex]['dayAfterStart'] - 1)))}',
//                                               style: f14Gray800w500,
//                                             )
//                                           : SizedBox(),
//                                       Spacer(),
...
//                                         child: Center(
//                                             child: Text(
//                                           '${js.planBJList[dayIndex]['planList'].length}',
//                                           style: f12Whitew700,
//                                         )),
//                                       ),
//                                       const SizedBox(
...
//                                         },
//                                         child: SvgPicture.asset(js.planBJList[dayIndex]['checked']
//                                             ? 'assets/icon/caretDown.svg'
//                                             : 'assets/icon/caretUp.svg'),
//                                       ),
//                                     ],
//                                   ),
//                                 ),
...
//                                       child: js.planBJList[dayIndex]['checked'] == true
//                                           ? Padding(
...
//                                                                           bottomRight:
//                                                                               Radius.circular(0), // 우측 하단 반경 0px
//                                                                           bottomLeft:
//                                                                               Radius.circular(4), // 좌측 하단 반경 4px
//                                                                         ),
//                                                                       ),
//                                                                       child: Center(
//                                                                           child: Text(
//                                                                         '${js.planBJList[dayIndex]['planList'][planIndex]['startTime'].toString().substring(0, 5)}',
...
//                                                                           bottomRight:
//                                                                               Radius.circular(4), // 우측 하단 반경 0px
//                                                                           bottomLeft:
//                                                                               Radius.circular(0), // 좌측 하단 반경 4px
//                                                                         ),
//                                                                       ),
//                                                                       child: Padding(
...
//                                                                           children: [
//                                                                             js.planBJList[dayIndex]['planList']
//                                                                                         [planIndex]['memo'] !=
//                                                                                     ''
//                                                                                 ? PopupMenuButton(
//                                                                                     offset: Offset(-34, 35),
...
//                                                                                           child: Text(
//                                                                                               '${js.planBJList[dayIndex]['planList'][planIndex]['memo']}',
...
//                                                                             Expanded(
//                                                                                 child: Text(
//                                                                               '${js.planBJList[dayIndex]['planList'][planIndex]['title']}',
//                                                                               style: f12Gray800w500,
...
//                                                                                 PopupMenuItem<int>(
//                                                                                   onTap: () {
//                                                                                     js.selectPlanBJList.value =
//                                                                                         js.planBJList[dayIndex]
//                                                                                             ['planList'][planIndex];
//                                                                                     Get.to(() => EditPlanBJ());
//                                                                                   },
//                                                                                   padding: EdgeInsets.zero,
...
//                                                                                   onTap: () async {
//                                                                                     print(
//                                                                                         'start??${js.planBJList[dayIndex]['dayAfterStart']}');
//                                                                                     await js.deletePlanBJList(
//                                                                                         js.planBJList[dayIndex]
//                                                                                                 ['planList'][planIndex]
//                                                                                             ['planId'],
//                                                                                         js.planBJList[dayIndex]
...
//                                                                                         js.planBJList[dayIndex]
//                                                                                             ['planList'][planIndex];
//                                                                                     js.planBSelectedDate.value = ts
//                                                                                         .selectTripList[0]['startDate'];
//                                                                                     js.selectPlanBJList['locker'] =
//                                                                                         false;
//                                                                                     js.selectPlanBJList[
//                                                                                                 'dayAfterStart'] ==
//                                                                                             -1
