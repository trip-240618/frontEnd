...
//     } else {
//       js.planBSelectedDate.value = DateFormat('yyyy-MM-dd').format(DateFormat('yyyy-MM-dd')
//           .parse(ts.selectTripList[0]['startDate'])
//           .add(Duration(days: js.selectPlanBJList['dayAfterStart'] - 1)));
//     }
//     js.planBAddDate.value =
//         DateFormat('yyyy.MM.dd (EEE)', 'ko_KR').format(DateTime.parse('${js.planBSelectedDate.value}'));
//
//     /// 시간
...
//       Map data = {
//         "formattedAddress": "",
//         "location": {"latitude": js.selectPlanBJList['latitude'], "longitude": js.selectPlanBJList['longitude']},
//         "displayName": {"text": js.selectPlanBJList['place'], "languageCode": "ko"}
//       };
...
//                                           Padding(
//                                             padding:
//                                                 const EdgeInsets.only(top: 1.67, bottom: 2.5, left: 2.5, right: 6.5),
...
//                                             ),
//                                             Text(
//                                               '${DateFormat('yyyy.MM.dd (EEE)', 'ko').format(DateTime.parse(js.planBSelectedDate.value))}',
...
//                                         width: 4,
//                                       ),
//                                       Text('${DateFormat('a hh:mm', 'ko_KR').format(js.addSelectedDateTime.value)}',
//                                           style: f15gray800w500),
//                                     ],
//                                   ),
//                                 )
...
//                                       height: 20,
//                                       decoration:
//                                           BoxDecoration(color: gray900, borderRadius: BorderRadius.circular(100)),
//                                       child: Center(
...
//                         GestureDetector(
//                           onTap: () {
//                             js.searchLocation.isEmpty ? Get.to(() => {}) : null;
//                           },
//                           child: Container(
//                             decoration: BoxDecoration(
//                               color: gray50,
...
//                                       children: [
//                                         Text(
//                                           '${js.searchLocation[0]['displayName']['text']}',
//                                           style: f15gray800w500,
...
//                                     target: LatLng(double.parse('${js.searchLocation[0]['location']['latitude']}'),
//                                         double.parse('${js.searchLocation[0]['location']['longitude']}')),
//                                     zoom: 14.4746,
//                                   ),
//                                   onTap: (argument) {
//                                     if (js.searchLocation.isNotEmpty) Get.to(() => {});
//                                   },
//                                   markers: {
//                                     Marker(
//                                       markerId: MarkerId('${js.searchLocation[0]['displayName']['text']}'),
//                                       position: LatLng(double.parse('${js.searchLocation[0]['location']['latitude']}'),
//                                           double.parse('${js.searchLocation[0]['location']['longitude']}')),
//                                       onTap: () {
...
//                                     },
//                                     scrollPadding:
//                                         EdgeInsets.only(bottom: MediaQuery.of(context).viewInsets.bottom + 160),
//                                     decoration: InputDecoration(
//                                       isDense: true,
//                                       contentPadding: EdgeInsets.zero,
//                                       enabledBorder: OutlineInputBorder(
...
//
//                   /// 시작 날짜
//                   DateTime selectedDate = DateTime.parse(js.planBSelectedDate.value);
//
//                   /// 선택된 날짜
