                            ...
                            GestureDetector(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Text('${DateFormat('a hh:mm', 'ko_KR').format(js.planBAddSelectedDateTime.value)}',
                                      style: f15gray800w500),
                                ],
                              ),
                            )
                        ...
                        isDateTBD
                            ? GestureDetector(
                                ...
                                child: Container(
                                  width: 20,
                                  height: 20,
                                  decoration: BoxDecoration(color: gray900, borderRadius: BorderRadius.circular(100)),
                                  child: Center(
                          ...
                          children: [
                            Expanded(
                              child: TextFormField(
                                ...
                                scrollPadding: EdgeInsets.only(bottom: MediaQuery.of(context).viewInsets.bottom + 160),
                                decoration: InputDecoration(
                                  isDense: true,
                                  contentPadding: EdgeInsets.zero,
                                  enabledBorder: OutlineInputBorder(
