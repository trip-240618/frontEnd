...
// import 'package:tripStory/presentation/trip/locker/scrap/scrap_edit.dart';
// import 'package:tripStory/presentation/trip/locker/scrap/scrap_view.dart';
//
...
//                                   isLoading = true;
//                                 });
//                                 bookmarkChecked ? await ss.getScrapBookmark() : await ss.getScrapList();
//                                 setState(() {
//                                   isLoading = false;
//                                 });
//                                 setState(() {});
...
//                                   //height: 194*(index/2),
//                                   constraints: BoxConstraints(maxHeight: 231, minHeight: 133),
//                                   child: Column(
...
//                                                     .format(DateTime.parse('${ss.scrapList[index]['createDate']}')),
//                                                 style: f11Gray900w400,
//                                               ),
//                                             ],
//                                           ),
//                                         ),
...
//                                               height: 4,
//                                             ),
//                                             Text(jsonToString(ss.scrapList[index]['preview']),
//                                                 overflow: TextOverflow.ellipsis, maxLines: 4, style: f12Gray800w500)
//                                           ],
//                                         ),
//                                       ),
//                                       Container(
...
//                                             children: [
//                                               Text(
//                                                 '${ss.scrapList[index]['nickname']}',
//                                                 style: f11Gray600w400,
//                                               ),
//                                               Spacer(),
//                                               us.userList[0].uuid == ss.scrapList[index]['writerUuid']
//                                                   ? GestureDetector(
...
//                                                             context, '스크랩을 삭제하시겠습니까?', '확인', '스크랩 삭제 후 복구는 어렵습니다',
//                                                             () async {
//                                                           await ss
//                                                               .deleteScrap(int.parse('${ss.scrapList[index]['id']}'));
//                                                           await ss.getScrapList();
//                                                           Get.back();
//                                                         });
//                                                       },
