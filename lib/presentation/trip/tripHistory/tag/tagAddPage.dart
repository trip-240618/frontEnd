                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(
                        '${_tagCon.text.length}',
                        style: _tagCon.text.length > 0 ? f11Gray800w600 : f11Gray400w600,
                      ),
                      Text(
                        '/7 ',
                      ...
                      tagList.length != 2 && _tagCon.text.length > 0
                          ? GestureDetector(
                              onTap: () {
                                if (tagList.length != 2) {
                                  tagList.add({'name': _tagCon.text, 'color': colorList[selectedColor]});
                          ...
                          child: Stack(
                            children: [
                              Padding(
                                ...
                                child: Container(
                                  decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(4), border: Border.all(color: gray200)),
                                  child: Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Container(
                                          ...
                                          height: 16,
                                          decoration:
                                              BoxDecoration(color: entry.value['color'], shape: BoxShape.circle),
                                          child: Center(
                                              child: Text(
                                            '#',
                                            style: entry.value['color'] == Color(0xffffffff)
                                                ? f12gray900w500
                                                : f12whitew500,
                                          )),
                                        ),
