...
import 'package:tripStory/presentation/trip/tripHistory/search/search_history_page.dart';
                          ...
                          return CustomScrollView(
                            ...
                            slivers: [
                              ...
                              Obx(() => SliverPadding(
                                    ...
                                    sliver: SliverList(
                                        delegate: SliverChildBuilderDelegate(childCount: hs.historyList.length,
                                            (context, index) {
                                      return Column(
                                        children: [
                                          Container(
                                                        ...
                                                        child: Row(
                                                          children: [
                                                            ...
                                                            Container(
                                                                ...
                                                                child: Center(
                                                                    child: Text(
                                                                  '${hs.historyList[index]['historyList'].length}',
                                                                  style: f11whitew600,
                                                                ))),
                                                          ],
                                                        ),
                                                                  ...
                                                                  GestureDetector(
                                                                    onTap: () {
                                                                      Get.to(() => TripHistoryDetailPage(
                                                                            selectedIdx: idx,
                                                                            dayIdx: index,
                                                                            historyId: hs.historyList[index]
                                                                                ['historyList'][idx]['id'],
                                                                          ));
                                                                    },
                                                                    child: Container(
                                                                      ...
                                                                      child: Stack(
                                                                        children: [
                                                                          Positioned(
                                                                            child: hs.historyList[index]['historyList']
                                                                                        [idx]['thumbnail'] ==
                                                                                    ''
