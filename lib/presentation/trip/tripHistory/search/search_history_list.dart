...
import 'package:tripStory/presentation/trip/tripHistory/search/search_full_map.dart';
import 'package:tripStory/presentation/trip/tripHistory/search/search_history_detail.dart';
                          ...
                          child: Row(
                            ...
                            children: [
                              Container(
                                ...
                                child: Center(
                                  child: Text('#',
                                      style: hs.selectedTagList[0]['tagColor'] == 'FFFFFFFF'
                                          ? f12gray900w500
                                          : f12whitew500),
                                ),
                              ),
                          ...
                          child: Row(
                            ...
                            children: [
                              Container(
                                ...
                                child: ClipRRect(
                                  borderRadius: BorderRadius.circular(4),
                                  child: hs.selectedTagList[0]['thumbnail'] == ''
                  ...
                  child: GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return GestureDetector(
                          onTap: () {
                            Get.to(() => SearchHistoryDetail(historyId: hs.searchList[index]['id'], pageIdx: index));
                          },
                          child: Container(
                            width: 120,
                            child: Stack(
                              children: [
                                Positioned(
                                  child: hs.searchList[index]['thumbnail'] == ''
                                      ? DefaultProfileScreen(context)
                                      : CachedNetworkImage(
                                ...
                                Positioned(
                                  ...
                                  child: Container(
                                    width: 20,
                                    height: 20,
                                    child: hs.searchList[index]['profileImage'] == ''
                                        ? DefaultProfileScreen(context)
                                        : CachedNetworkImage(
