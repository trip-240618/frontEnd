...
import 'package:tripStory/presentation/trip/tripHistory/search/search_history_list.dart';
                  ...
                  ? Obx(() => Wrap(
                        ...
                        children: (hs.tagSearchList.length != 0 ? hs.tagSearchList : []).map<Widget>((info) {
                          return hs.tagSearchList[0].containsKey('tagName')
                              ? GestureDetector(
                                  onTap: () async {
                                    await hs.getSelectedTag(
                                        ts.selectTripList[0]['id'], '${info['tagName']}', '${info['tagColor']}');
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: Center(
                                              child: Text('#',
                                                  style:
                                                      info['tagColor'] == 'FFFFFFFF' ? f12gray900w500 : f12whitew500),
                                            ),
                                          ),
                                                ...
                                                onTap: () {
                                                  if (selectedColor == index) {
                                                    ...
                                                    List filteredTags = hs.tagAllList.where((tag) {
                                                      return tag['tagColor'] ==
                                                          '${colorList[index].value.toRadixString(16).toUpperCase()}';
                                                    }).toList();
                                                ...
                                                child: selectedColor == index
                                                    ...
                                                    : Container(
                                                        ...
                                                        decoration: BoxDecoration(
                                                            shape: BoxShape.circle,
                                                            color: colorList[index],
                                                            border: colorList[index] == whiteColor
                        ...
                        isColorFilter
                            ...
                            : selectedIdx == 0
                                ? Obx(() => Wrap(
                                      ...
                                      children: (hs.tagAllList.length != 0 ? hs.tagAllList : []).map<Widget>((tag) {
                                        return GestureDetector(
                                          onTap: () async {
                                            hs.getSelectedTag(
                                                ts.selectTripList[0]['id'], '${tag['tagName']}', '${tag['tagColor']}');
                                ...
                                : Obx(() => Wrap(
                                      ...
                                      spacing: 12,
                                      runSpacing: 12,
                                      children: (ts.selectTripList[0]['tripMemberDtoList'].length != 0
