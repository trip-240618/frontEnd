...
import 'package:tripStory/presentation/trip/tripHistory/history/full_screen_image.dart';
...
class _TripHistoryDetailPageState extends State<TripHistoryDetailPage> {
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () async {
      hs.getDetailHistoryCommentList(
          ts.selectTripList[0]['id'], hs.historyList[widget.dayIdx]['historyList'][selectedPageIdx]['id']);
    });
      ...
      child: Scaffold(
        body: PageView.builder(
          ...
          onPageChanged: (v) {
            selectedPageIdx = v;
            hs.getDetailHistoryCommentList(
                ts.selectTripList[0]['id'], hs.historyList[widget.dayIdx]['historyList'][v]['id']);
            setState(() {});
          },
          itemBuilder: (context, pageIdx) {
            return Obx(() => SingleChildScrollView(
                  ...
                  physics: const ClampingScrollPhysics(),
                  child: hs.historyList[widget.dayIdx]['historyList'].length == 0
                      ? const SizedBox()
                      : Padding(
                            ...
                            children: [
                              Stack(
                                children: [
                                  GestureDetector(
                                    onTap: () {
                                      Get.to(() => FullScreenImage(
                                          imageUrl:
                                              '${hs.historyList[widget.dayIdx]['historyList'].length == 0 || hs.historyList[widget.dayIdx]['historyList'][pageIdx].length == 0 ? '' : hs.historyList[widget.dayIdx]['historyList'][pageIdx]['thumbnail']}'));
                                    },
                                  ...
                                  us.userList[0].uuid ==
                                          hs.historyList[widget.dayIdx]['historyList'][selectedPageIdx]['writerUuid']
                                      ? Positioned(
                                          top: 30,
                                          right: 20,
                                          child: GestureDetector(
                                                ...
                                                PopupMenuItem<int>(
                                                  onTap: () {
                                                    ...
                                                    hs.deleteHistory(
                                                        ...
                                                        hs.historyList[widget.dayIdx]['historyList'][selectedPageIdx]
                                                            ['id'],
                                                        hs.historyList[widget.dayIdx]['historyList'][pageIdx]
                                                            ['thumbnail']);
                                                    hs.historyList[widget.dayIdx]['historyList'].removeWhere((item) =>
                                                        item['id'] ==
                                                        hs.historyList[widget.dayIdx]['historyList'][selectedPageIdx]
                                                            ['id']);
                                          ...
                                          Row(
                                            children: [
                                              hs.historyList[widget.dayIdx]['historyList'][selectedPageIdx]
                                                  ...
                                                  : CachedNetworkImage(
                                                      imageUrl: hs.historyList[widget.dayIdx]['historyList']
                                                          [selectedPageIdx]['profileImage'],
                                                      width: 24,
                                                      height: 24,
                                                      fit: BoxFit.cover,
                                              ...
                                              Text(
                                                '${hs.historyList[widget.dayIdx]['historyList'][selectedPageIdx]['nickname']}',
                                                style: f12whitew600,
                                              ),
                                              const SizedBox(
                                                width: 4,
                                              ...
                                              Text(
                                                '${hs.historyList[widget.dayIdx]['historyList'][selectedPageIdx]['photoDate']}',
                                                style: f12whitew600,
                                              )
                                            ],
                                          ),
                              ...
                              hs.historyList[widget.dayIdx]['historyList'][pageIdx]['tags'][0] == null
                                  ? Container(
                                      width: Get.width,
                                      height: 52,
                                      color: gray50,
                                  ...
                                  : Container(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Wrap(
                                          ...
                                          spacing: 12,
                                          children: hs.historyList[widget.dayIdx]['historyList'][pageIdx]['tags']
                                              .map<Widget>((tag) {
                                            return Container(
                                              decoration: BoxDecoration(
                                                color: Colors.white,
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        GestureDetector(
                                            onTap: () async {
                                              await hs.historyListToggle(
                                                  ts.selectTripList[0]['id'], widget.historyId, false);
                                            },
                                            child: SvgPicture.asset('assets/icon/heart.svg',
                                                colorFilter: ColorFilter.mode(
                                                    hs.historyList[widget.dayIdx]['historyList'][pageIdx]['like'] ??
                                                            false
                                                        ? gray900
                                                        : gray300,
                                                    BlendMode.srcIn))),
                                        const SizedBox(width: 4),
                                        Text(
                                          '${hs.historyList[widget.dayIdx]['historyList'][pageIdx]['likeCnt']}',
                                        ...
                                        const SizedBox(width: 4),
                                        Text(
                                          '${hs.historyList[widget.dayIdx]['historyList'][pageIdx]['replyCnt']}',
                                          style: f14Gray800w500,
                                        ),
                                      ],
                                    ),
                                              ...
                                              children: [
                                                Row(
                                                  children: [
                                                    ...
                                                    Text(
                                                      '${hs.timeFormat(hs.historyComment[index]['createDate'])}',
                                                            ...
                                                            itemBuilder: (context) => [
                                                                  PopupMenuItem(
                                                                    onTap: () async {
                                                                      await rs.addReport(
                                                                          'reply',
                                                                          hs.historyList[widget.dayIdx]['historyList']
                                                                              [selectedPageIdx]['id'],
                                                                          hs.historyComment[index]['id']);
                                                                      showOnlyConfirmTapDialog(
                                                                          context, '신고 접수가 완료되었습니다.', () {
                                                                        Get.back();
                                                                      });
                                                                    },
                                                                    padding: EdgeInsets.zero,
