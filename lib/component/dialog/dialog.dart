              ...
              content: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    isFirstCheck && isRegCheck && !isValue
                        ? Padding(
                            padding: const EdgeInsets.only(left: 16, top: 4),
                            child: Text(
                              '존재하지 않는 초대 코드입니다',
                ...
                GestureDetector(
                  ...
                  child: Center(
                    child: Container(
                      ...
                      height: 60,
                      decoration:
                          BoxDecoration(color: isRegCheck ? gray900 : gray300, borderRadius: BorderRadius.circular(4)),
                      child: Center(
                          child: Text(
                        '연결하기',
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Container(
                      width: 60,
                      height: 60,
                      decoration: BoxDecoration(color: gray200, borderRadius: BorderRadius.circular(4)),
...
/// 확인 취소 다이얼로그
showConfirmCancelTapDialog(
    BuildContext context, String title, String actionText, String? message, VoidCallback confirmTap) {
  showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      SvgPicture.asset('assets/icon/plane.svg',
                              ...
                              Container(
                                ...
                                child: Padding(
                                  padding: EdgeInsets.all(16),
                                  child: Text(
                                    '${js.flightList[0]['departureAirport_kr']}(${js.flightList[0]['departureAirport']})',
                                    style: f15gray800w500,
                                  ),
                                ),
                              ),
                              ...
                              Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      SvgPicture.asset('assets/icon/departureFlight.svg',
                                          colorFilter: ColorFilter.mode(
                                              Color(ts.selectTripList[0]['labelColor']), BlendMode.srcIn)),
                                      const SizedBox(
                                        width: 6,
                                      ...
                                      Text(
                                        '${DateFormat('yyyy.MM.dd (EEE)', 'ko_KR').format(DateTime.parse(js.flightList[0]['departureDate']).toLocal())}',
                                        style: f15gray800w500,
                                      ),
                                      Text(
                                        ' ${js.flightList[0]['departureDate'].split('T')[1].split('+')[0]}',
                                        style: f15gray800w500,
                                      ),
                                    ],
                                  ),
                              ...
                              Container(
                                ...
                                child: Padding(
                                  padding: EdgeInsets.all(16),
                                  child: Text(
                                    '${js.flightList[0]['arrivalAirport_kr']}(${js.flightList[0]['arrivalAirport']})',
                                    style: f15gray800w500,
                                  ),
                                ),
                              ),
                              ...
                              Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      SvgPicture.asset('assets/icon/arrivalFlight.svg',
                                          colorFilter: ColorFilter.mode(
                                              Color(ts.selectTripList[0]['labelColor']), BlendMode.srcIn)),
                                      const SizedBox(
                                        width: 6,
                                      ...
                                      Text(
                                        '${DateFormat('yyyy.MM.dd (EEE)', 'ko_KR').format(DateTime.parse(js.flightList[0]['arrivalDate']).toLocal())}',
                                        style: f15gray800w500,
                                      ),
                                      Text(
                                        ' ${js.flightList[0]['arrivalDate'].split('T')[1].split('+')[0]}',
                                        style: f15gray800w500,
                                      ),
                                    ],
                                  ),
