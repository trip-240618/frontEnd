...
class _TripDataSource implements TripDataSource {
  ...
  @override
  Future<void> putSwapJPlan(int tripId, PlanJSwapRequest request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = request;
  ...
  @override
  Future<void> fetchRegisterJPlan(int tripId, int day) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<void> fetchRegisterFinishJPlan(int tripId, int day) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
