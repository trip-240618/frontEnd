...
class ScrapCreateUseCase
    implements UseCase<ScrapDetailEntity, Tuple2<int, ScrapCreateEntity>> {
  final TripRepository _tripRepository;

  ScrapCreateUseCase(this._tripRepository);

  @override
  ResultFuture<ScrapDetailEntity> call(
      Tuple2<int, ScrapCreateEntity> params) async {
    final tripId = params.value1;
    final entity = params.value2;

    return _tripRepository.createScrap(
        tripId: tripId, scrapCreateEntity: entity);
  }
}
